  ...
  return (
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      <div>
        ...
        <p className="text-yellow-200 text-lg font-medium mt-2 ">
          Desarrollador junior
        </p>
        <p className="text-gray-400/50 text-md mt-4 lg:max-w-xs leading-normal">
          Construyo aplicaciones <span className=" text-yellow-200/90">web</span> y tipo movil, accesibles y intuitivas para
          cada usuario
        </p>
